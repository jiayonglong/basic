...
<!--    </div>-->
    ...
    <a href="javascript:;" onClick="user_add('550','','添加公告','index.php?r=admin/add')" class="btn btn-primary radius"><i class="icon-plus"></i> 添加公告</a></span>
    ...
    <table class="table table-border table-bordered table-hover table-bg  table-sort">
        ...
        <tr class="text-c">
            ...
            <th width="80">ID</th>
            <th width="100">管理员名字</th>
            <th width="40">管理员手机号</th>
            <th width="100">操作</th>
        </tr>
        </thead>
        <center>
        ...
        <?php foreach($data as $key=>$val):?>
            <tr>
                ...
                <td><?php echo $val['admin_plone']?></td>
                <td>
                    <a href="index.php?r=admin/del&admin_id=<?php echo $val['admin_id'];?>">删除</a>
                    <a href="index.php?r=admin/update&admin_id=<?php echo $val['admin_id'];?>">修改</a>
                </td>
            </tr>
        <?php endforeach;?>
<!--        <tr class="text-c">-->
