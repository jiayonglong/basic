...
<div class="pd-20">
    ...
    $form=ActiveForm::begin([
        'action'=>Url::toRoute(['notice/list']), //跳转的地址
        'method'=>'get',

    ]);
    echo '名称:','',Html::input('t_notice','notice_title');
...
<!--    </div>-->
    ...
    <a href="javascript:;" onClick="user_add('550','','添加公告','index.php?r=notice/add')" class="btn btn-primary radius"><i class="icon-plus"></i> 添加公告</a></span>
    ...
    <table class="table table-border table-bordered table-hover table-bg  table-sort">
        ...
        <?php foreach($data as $key=>$val):?>
            <tr>
                ...
                <td><?php echo $val['notice_id']?></td>
                <td><?php echo $val['notice_title']?></td>
                <td><?php echo $val['notice_content']?></td>
                <td><?php echo $val['pub_name']?></td>
                <td>
                    <a href="index.php?r=notice/del&notice_id=<?php echo $val['notice_id'];?>">删除</a>
                    <a href="index.php?r=notice/update&notice_id=<?php echo $val['notice_id'];?>">修改</a>
                </td>
            </tr>
        <?php endforeach;?>
<!--        <tr class="text-c">-->
