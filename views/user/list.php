...
<div class="pd-20">
    ...
    $form=ActiveForm::begin([
        'action'=>Url::toRoute(['user/list']), //跳转的地址
        'method'=>'get',

    ]);
    echo '名称:','',Html::input('user_name','user_name');
        ...
        <center>
            ...
            <?php foreach($data as $key=>$val):?>
                <tr>
                    ...
                    <td><?php echo $val['user_plone']?></td>
                    <td><?php echo $val['user_head']?></td>
                    <td><?php echo $val['user_email']?></td>
                    <td>
                        <a href="index.php?r=user/del&user_id=<?php echo $val['user_id'];?>">删除</a>
                        <a href="index.php?r=user/update&user_id=<?php echo $val['user_id'];?>">修改</a>
                    </td>
                </tr>
            <?php endforeach;?>
            <!--        <tr class="text-c">-->
