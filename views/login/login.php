...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        <form action="index.php?r=login/store" method="post">
            <div class="formRow user">
                <input id="" name="admin_name" type="text" placeholder="用户名" class="input_text input-big">
            </div>
            <div class="formRow password">
                <input id="" name="admin_pwd" type="password" placeholder="密码" class="input_text input-big">
            </div>
            <div class="formRow">
