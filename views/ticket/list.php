...
<div class="pd-20">
    ...
    $form=ActiveForm::begin([
        'action'=>Url::toRoute(['ticket/list']), //跳转的地址
        'method'=>'get',
...
<!--    </div>-->
    ...
    <a href="javascript:;" onClick="user_add('550','','添加门票','index.php?r=ticket/add')" class="btn btn-primary radius"><i class="icon-plus"></i> 添加公告</a></span>
    ...
    <table class="table table-border table-bordered table-hover table-bg  table-sort">
        ...
        <tr class="text-c">
            ...
            <th width="80">ID</th>
            <th width="100">展厅影院</th>
            <th width="40">票类型</th>
            <th width="150">入馆时间</th>
            <th width="150">票数量</th>
            <th width="150">票价格</th>
            <th width="150">入馆时间</th>
            <th width="150">开始售票时间</th>
            <th width="150">结束售票时间</th>
            <th width="150">是否售完</th>
            <th width="100">操作</th>
        </tr>
        </thead>
        <center>
        ...
        <?php foreach($data as $key=>$val):?>
            <tr>
                ...
                <td><?php if($val['ticket_type']==0){echo '普通票';} elseif ($val['ticket_type']==1){echo '学生票';}?></td>
                <td><?php echo $val['library_time']?></td>
                <td><?php echo $val['ticket_price']?></td>
                <td><?php echo $val['ticket_number']?></td>
                <td><?php echo date('Y-m-d',$val['ticket_number']);?></td>
                <td><?php echo date('Y-m-d',$val['start_time']);?></td>
                <td><?php echo date('Y-m-d',$val['end_time']);?></td>
                <td><?php if($val['ticket_state']==0){echo '已售完';} else {echo '未售完';}?></td>
                <td>
                    <a href="index.php?r=ticket/del&t_id=<?php echo $val['t_id'];?>">删除</a>
                    <a href="index.php?r=ticket/update&t_id=<?php echo $val['t_id'];?>">修改</a>
                </td>
            </tr>
        <?php endforeach;?>
<!--        <tr class="text-c">-->
